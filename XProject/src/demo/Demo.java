...
import demo.practice.Polymorphism.Circle;
import demo.practice.Polymorphism.Cube;
import demo.practice.Polymorphism.IShape;
import demo.practice.account.SavingAccount;
import demo.practice.alarmadvance.AlarmDoor;
import demo.practice.animal.Cat;
import demo.practice.animal.Dog;
import demo.practice.animal.NewBorn;
import demo.practice.annotation.ParseAnnotation;
import demo.practice.annotation.UserAnnotation;
import demo.practice.classexample.SubClass;
import demo.practice.messivealarm.MessiveAlarmDoor;
...
//        playMessiveAlarm(); // interface, abstract class combination.
    ...
    private static void accountFunTime() {
